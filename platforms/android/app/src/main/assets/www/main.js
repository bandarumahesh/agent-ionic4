...
var map = {
	...
	"./pages/membership-for-agency/membership-for-agency.module": [
...
var AppComponent = /** @class */ (function () {
    function AppComponent(authService, router, platform, splashScreen, statusBar, storage) {
...
/* harmony import */ var _resolver_data_resolver_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./resolver/data-resolver.service */ "./src/app/resolver/data-resolver.service.ts");
...
/* harmony import */ var _core_auth_http_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./core/auth/http.interceptor */ "./src/app/core/auth/http.interceptor.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                _resolver_data_resolver_service__WEBPACK_IMPORTED_MODULE_9__["DataResolverService"],
                _services_data_service__WEBPACK_IMPORTED_MODULE_10__["DataService"],
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HTTP_INTERCEPTORS"],
                    useClass: _core_auth_http_interceptor__WEBPACK_IMPORTED_MODULE_12__["MyHttpInterceptor"],
                    multi: true,
                }
            ],
...
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./auth.service */ "./src/app/core/auth/auth.service.ts");
...
var AuthService = /** @class */ (function () {
    function AuthService(httpClient, storage, platform, router) {
        var _this = this;
    ...
    AuthService.prototype.getAuthStateObserver = function () {
    ...
    AuthService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"],
            ...
            _ionic_angular__WEBPACK_IMPORTED_MODULE_0__["Platform"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], AuthService);
    return AuthService;
}());
...
var MyHttpInterceptor = /** @class */ (function () {
    ...
    MyHttpInterceptor.prototype.intercept = function (request, next) {
        ...
        var headersData = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]();
...
module.exports = __webpack_require__(/*! /Instarent/Instarent Repos/agent_test_project/ionic4-template/src/main.ts */"./src/main.ts");
